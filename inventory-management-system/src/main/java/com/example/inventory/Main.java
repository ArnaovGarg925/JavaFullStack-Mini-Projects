 ...
 * Main
 * ---------------------------------------------------------
 * Entry point and console UI (menu layer) for the Inventory
 * Management System. Responsible only for displaying menus,
 * reading user input, and delegating actual work to
 * InventoryManager / ReportService / AutoSaveService.
 *
 * Menu structure:
 *   1. Product Management  -> Add / View / Search / Update / Delete / Apply Discount
 *   2. Category Management -> Add / View / Update / Delete
 *   3. Stock Management    -> Add Stock / Remove Stock / View
 *   4. Reports             -> Low Stock / Inventory Value Report (multithreaded) / Export CSV
 *   5. Exit
 */
public class Main {
