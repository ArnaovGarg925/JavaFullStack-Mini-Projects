 ...
 * Product
 * ---------------------------------------------------------
 * Represents a single inventory item for sale.
 *
 * OOP concepts demonstrated:
 *  - Inheritance   : extends the abstract {@link InventoryItem} class.
 *  - Interfaces    : implements {@link Reportable} and {@link Discountable}
 *                    at the same time (multiple interface implementation).
 *  - Encapsulation : all fields are private, accessed only via getters/setters.
 *  - Polymorphism  : overrides getDetails(), generateReport() and toString().
 */
